			...
			<form action="${pageContext.request.contextPath}/book/update" method="post">
				<div>
					<label for="">bookCode : </label><span>${bookCode}</span></br> <input
						type="text" name="bookCode" placeHolder="bookCode" value="${bookDto.bookCode }" readonly/></br>
				</div>
				<div>
					<label for="">bookName : </label><span>${bookName}</span></br> <input
						type="text" name="bookName" placeHolder="bookName" value="${bookDto.bookName }"/></br>
				</div>
				<div>
					<label for="">publisher : </label><span>${publisher}</span></br> <input
						type="text" name="publisher" placeHolder="publisher" value="${bookDto.publisher }"/></br>
				</div>
				<div>
					<label for="">isbn : </label><span>${isbn}</span></br> <input
						type="text" name="isbn" placeHolder="isbn" value="${bookDto.isbn }"/></br>
				</div>
