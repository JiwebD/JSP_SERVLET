	...
	<div class="wrapper">
		...
		<main>
			...
			<table>
				...
				<%@page import="java.time.LocalTime,java.time.Period,java.time.LocalDate,java.time.format.DateTimeFormatter" %>
				<tr>
					<td><%=voteDto2.getV_name() %></td>
					
					<%
						String birthYear = voteDto2.getV_jumin().substring(0, 6);
