...
class DaoTests {
	...
	void test6() throws Exception {
		BookReplyDaoImpl.getInstance().insert(new BookReplyDto(-1,"CDG000000001","user1","내용내용",LocalDateTime.now()));

	}
	
	@Test
	void test7() throws Exception {
		BookReplyDaoImpl.getInstance().selectAll("CDJ000025512").forEach(System.out::println);
